/* empty css                          */
import { e as createComponent, r as renderTemplate, m as maybeRenderHead, h as createAstro, g as addAttribute, i as renderComponent, j as renderHead, k as renderSlot, l as renderTransition } from '../astro_DlT0T743.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
import { $ as $$Image } from './generic_DjI86q4s.mjs';
/* empty css                          */
/* empty css                          */
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<footer class=""> <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8"> <div class="sm:flex sm:items-center sm:justify-between"> <div class="flex justify-center text-teal-600 sm:justify-start"> <svg class="h-8" viewBox="0 0 118 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <!-- <path
          ...
          <path
            ...
            fill="currentColor"></path> --> </svg> </div> <p class="text-pii-green-bg text-center text-sm">Site Developed in Astro ❤️</p> <p class="text-pii-green-bg mt-4 text-center text-sm lg:mt-0 lg:text-right">
Copyright &copy; 2024. All rights reserved.
</p> </div> </div> </footer>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/components/Footer.astro", void 0);
...
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Main = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body class="bg-pii-black"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})}  </body></html>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/layouts/Main.astro", void 0);

const logoMain = new Proxy({"src":"/_astro/navbar-logo.DD5TABvZ.png","width":768,"height":768,"format":"png"}, {
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Navbar;
  const { urlAboutMe = "#presentation", urlExperience = "#experience", urlProjects = "#projects" } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<header class="bg-white"> <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8"> <div class="flex h-16 items-center justify-between"> <div class="md:flex md:items-center md:gap-12"> <a class="block text-teal-600" href="/"> <span class="sr-only">Home</span> ${renderComponent($$result, "Image", $$Image, { "src": logoMain, "class": "w-10 h-10", "alt": "", "srcset": "" })} </a> </div> <div id="menu-open"> <nav aria-label="Global"> <ul class="flex items-center gap-4 text-pii-green"> <li> <a class="text-gray-500 transition hover:text-pii-green-bg/70"${addAttribute(urlAboutMe, "href")}> About me </a> </li> <li> <a class="text-gray-500 transition hover:text-pii-green-bg/70"${addAttribute(urlExperience, "href")}> Experience </a> </li> <li> <a class="text-gray-500 transition hover:text-pii-green-bg/70"${addAttribute(urlProjects, "href")}> Projects </a> </li> </ul> </nav> </div> <div class="flex items-center gap-4"> <div class="block md:hidden"> <!-- <button id="menu-button" class="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75">
            <svg
...
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/components/Navbar.astro", void 0);
...
const $$SectionTitle = createComponent(($$result, $$props, $$slots) => {
  ...
  const { title } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="flex justify-center mb-5"> <div class="w-auto"> <h2 class="text-pii-gray text-center text-3xl mx-14 mb-3">${title}</h2> <div class="pt-separator-div"></div> </div> </div>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/components/SectionTitle.astro", void 0);
...
const $$AllProjects = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div id="projects" class="mx-10 mt-12"> ${renderSlot($$result, $$slots["default"])} <div class="mt-4"> <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 mx-10"> ${listProjects.map((project) => renderTemplate`${renderComponent($$result, "Card", $$Card, { "title": project.title, "urlProject": project.urlProject, "urlGithub": project.urlGithub, "description": project.description, "photo": project.photo, "slug": project?.slug, "tags": project.tags })}`)} </div> </div> </div>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/sections/AllProjects.astro", void 0);

const $$Index$1 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Main, { "title": "Projects | Francisco Candelario" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navbar", $$Navbar, { "urlAboutMe": "/#aboutome", "urlExperience": "/#experience", "urlProjects": "/projects" })} ${renderComponent($$result2, "AllProjects", $$AllProjects, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "SectionTitle", $$SectionTitle, { "title": "All Projects" })} ` })} ` })}`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/pages/projects/index.astro", void 0);

const $$file$1 = "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/pages/projects/index.astro";
...
const $$Github = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Github;
  return renderTemplate`${maybeRenderHead()}<svg width="30" height="30" viewBox="0 0 100 100"${addAttribute(Astro2.props.class, "class:list")} role="img" aria-label="Logotipo de Github"> <path fill="currentColor" d="M48.854 0C21.839 0 0 22 0 49.217c0 21.756 13.993 40.172 33.405 46.69 2.427.49 3.316-1.059 3.316-2.362 0-1.141-.08-5.052-.08-9.127-13.59 2.934-16.42-5.867-16.42-5.867-2.184-5.704-5.42-7.17-5.42-7.17-4.448-3.015.324-3.015.324-3.015 4.934.326 7.523 5.052 7.523 5.052 4.367 7.496 11.404 5.378 14.235 4.074.404-3.178 1.699-5.378 3.074-6.6-10.839-1.141-22.243-5.378-22.243-24.283 0-5.378 1.94-9.778 5.014-13.2-.485-1.222-2.184-6.275.486-13.038 0 0 4.125-1.304 13.426 5.052a46.97 46.97 0 0 1 12.214-1.63c4.125 0 8.33.571 12.213 1.63 9.302-6.356 13.427-5.052 13.427-5.052 2.67 6.763.97 11.816.485 13.038 3.155 3.422 5.015 7.822 5.015 13.2 0 18.905-11.404 23.06-22.324 24.283 1.78 1.548 3.316 4.481 3.316 9.126 0 6.6-.08 11.897-.08 13.526 0 1.304.89 2.853 3.316 2.364 19.412-6.52 33.405-24.935 33.405-46.691C97.707 22 75.788 0 48.854 0z"></path> </svg>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/icons/Github.astro", void 0);
...
const $$ButtonPrimary = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")} class="bg-pii-green-bg px-4 py-2 rounded-full text-pii-green transform hover:scale-105 duration-300 ease-in-out" href="/projects"> ${text} </a>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/components/ButtonPrimary.astro", void 0);

const $$Astro$2 = createAstro();
const $$Linkedin = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Linkedin;
  return renderTemplate`${maybeRenderHead()}<svg width="30" height="30" viewBox="-143 145 512 512"${addAttribute(Astro2.props.class, "class:list")} role="img" aria-label="Logotipo de Linkedin"> <path fill="currentColor" d="M113,145c-141.4,0-256,114.6-256,256s114.6,256,256,256s256-114.6,256-256S254.4,145,113,145z M272.8,560.7 c-20.8,20.8-44.9,37.1-71.8,48.4c-27.8,11.8-57.4,17.7-88,17.7c-30.5,0-60.1-6-88-17.7c-26.9-11.4-51.1-27.7-71.8-48.4 c-20.8-20.8-37.1-44.9-48.4-71.8C-107,461.1-113,431.5-113,401s6-60.1,17.7-88c11.4-26.9,27.7-51.1,48.4-71.8 c20.9-20.8,45-37.1,71.9-48.5C52.9,181,82.5,175,113,175s60.1,6,88,17.7c26.9,11.4,51.1,27.7,71.8,48.4 c20.8,20.8,37.1,44.9,48.4,71.8c11.8,27.8,17.7,57.4,17.7,88c0,30.5-6,60.1-17.7,88C309.8,515.8,293.5,540,272.8,560.7z"></path> <rect fill="currentColor" x="-8.5" y="348.4" width="49.9" height="159.7"></rect> <path fill="currentColor" d="M15.4,273c-18.4,0-30.5,11.9-30.5,27.7c0,15.5,11.7,27.7,29.8,27.7h0.4c18.8,0,30.5-12.3,30.4-27.7 C45.1,284.9,33.8,273,15.4,273z"></path> <path fill="currentColor" d="M177.7,346.9c-28.6,0-46.5,15.6-49.8,26.6v-25.1H71.8c0.7,13.3,0,159.7,0,159.7h56.1v-86.3c0-4.9-0.2-9.7,1.2-13.1 c3.8-9.6,12.1-19.6,27-19.6c19.5,0,28.3,14.8,28.3,36.4v82.6H241v-88.8C241,369.9,213.2,346.9,177.7,346.9z"></path> </svg>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/icons/Linkedin.astro", void 0);

const $$Astro$1 = createAstro();
const $$Twitter = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$Twitter;
  return renderTemplate`${maybeRenderHead()}<svg width="30px" height="30px" viewBox="0 0 35 32"${addAttribute(Astro2.props.class, "class:list")} role="img" aria-label="Logotipo de X"> <g> <path style=" stroke:none;fill-rule:nonzero;fill:currentColor;fill-opacity:1;" d="M 27.535156 0 L 32.898438 0 L 21.117188 13.578125 L 34.882812 32 L 24.078125 32 L 15.621094 20.804688 L 5.9375 32 L 0.570312 32 L 13.054688 17.476562 L -0.128906 0 L 10.941406 0 L 18.585938 10.226562 Z M 25.65625 28.8125 L 28.628906 28.8125 L 9.378906 3.070312 L 6.183594 3.070312 Z M 25.65625 28.8125 "></path> </g> </svg>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/icons/Twitter.astro", void 0);

const $$Astro = createAstro();
const $$Email = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Email;
  return renderTemplate`${maybeRenderHead()}<svg width="30" height="30" viewBox="0 0 1920 1920"${addAttribute(Astro2.props.class, "class:list")} role="img" aria-label="Logotipo email"> <path fill="currentColor" d="M0 1694.235h1920V226H0v1468.235ZM112.941 376.664V338.94H1807.06v37.723L960 1111.233l-847.059-734.57ZM1807.06 526.198v950.513l-351.134-438.89-88.32 70.475 378.353 472.998H174.042l378.353-472.998-88.32-70.475-351.134 438.89V526.198L960 1260.768l847.059-734.57Z" fill-rule="evenodd"></path> </svg>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/icons/Email.astro", void 0);

const $$Profile = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="presentation" class="mt-5 flex flex-col justify-center items-center text-center"> <div class="flex flex-col justify-center items-center"> <img src="images/profile.png" alt="Francisco Cervantes" class="rounded-full w-3/4 h-3/4"> <h1 class="mt-4 text-3xl text-pii-gray">Francisco Cervantes</h1> <p class="mt-2 text-xl text-pii-green">Information Technology Engineering</p> </div> <div class="basis-full mx-28 mt-4 w-1/2"> <p class="text-pii-gray">
I am proactive, organized, and responsible person in my work. I enjoy challenges and I'm always in constant learning. 
                I like working in teams and I'm always ready to give my best for the completion of my tasks
</p> </div> <div id="social-networks" class="mt-10 flex gap-4 text-pii-green"> <a class="transform hover:scale-110 duration-300 ease-in-out" href="https://github.com/FranciscoJCC" target="_blank"> ${renderComponent($$result, "Github", $$Github, {})} </a> <a class="transform hover:scale-110 duration-300 ease-in-out" href="http://https://www.linkedin.com/in/francisco-candelario/" target="_blank"> ${renderComponent($$result, "Linkedin", $$Linkedin, {})} </a> <a class="transform hover:scale-110 duration-300 ease-in-out" href="https://twitter.com/FcoCandelario" target="_blank"> ${renderComponent($$result, "Twitter", $$Twitter, {})} </a> <a class="transform hover:scale-110 duration-300 ease-in-out" href="mailto:fjccandelario@gmail.com"> ${renderComponent($$result, "Email", $$Email, {})} </a> </div> </div>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/sections/Profile.astro", void 0);

const $$Timeline = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="experience" class="mx-10 mt-12" data-astro-cid-ip2sgust> <div class="flex justify-center mb-5" data-astro-cid-ip2sgust> <div class="w-auto" data-astro-cid-ip2sgust> <h2 class="text-pii-gray text-center text-3xl mx-14 mb-3" data-astro-cid-ip2sgust>Experience</h2> <div class="pt-separator-div" data-astro-cid-ip2sgust></div> </div> </div> <div class="timeline mt-4" data-astro-cid-ip2sgust> <div class="timeline-row" data-astro-cid-ip2sgust> <div class="timeline-time" data-astro-cid-ip2sgust> <p class="md:text-2xl" data-astro-cid-ip2sgust>Billpocket<small data-astro-cid-ip2sgust>Aug 22 - Nov 23</small></p> </div> <div class="timeline-content" data-astro-cid-ip2sgust> <!-- <i class="icon-attachment"></i> --> <h4 class="text-pii-green font-bold tracking-widest md:text-xl truncate" data-astro-cid-ip2sgust>Infrastructure Administrator</h4> <p class="text-pii-gray" data-astro-cid-ip2sgust>
We managed to standardize the offices in different countries.
          Implementation of a web application for access control, CCTV,
          inventories, and traditional infrastructure for the offices
</p> </div> </div> <div class="timeline-row" data-astro-cid-ip2sgust> <div class="timeline-time " data-astro-cid-ip2sgust>
Gateway Fabrication Solutions<small data-astro-cid-ip2sgust>May 22 - Aug 22</small> </div> <div class="timeline-content" data-astro-cid-ip2sgust> <h4 class="text-pii-green font-bold tracking-widest md:text-xl truncate" data-astro-cid-ip2sgust>Full Stack Developer</h4> <p class="text-pii-gray" data-astro-cid-ip2sgust>
I implemented a web application for order tracking, raw material
          inventory, and computer equipment inventory
</p> </div> </div> <div class="timeline-row" data-astro-cid-ip2sgust> <div class="timeline-time" data-astro-cid-ip2sgust>
Softlaw<small data-astro-cid-ip2sgust>Jul 21 - May 22</small> </div> <div class="timeline-content" data-astro-cid-ip2sgust> <h4 class="text-pii-green font-bold tracking-widest md:text-xl truncate" data-astro-cid-ip2sgust>Full Stack Developer</h4> <p class="text-pii-gray" data-astro-cid-ip2sgust>
I developed a web application to manage dispatch collections. The
          system allows the creation of contact campaigns via phone calls, text
          messages, and email
</p> </div> </div> <div class="timeline-row" data-astro-cid-ip2sgust> <div class="timeline-time" data-astro-cid-ip2sgust>
Teletón México Foundation A.C.<small data-astro-cid-ip2sgust>Feb 14 - Jul 21</small> </div> <div class="timeline-content" data-astro-cid-ip2sgust> <h4 class="text-pii-green font-bold tracking-widest md:text-xl truncate" data-astro-cid-ip2sgust>Systems Assistant</h4> <p class="text-pii-gray" data-astro-cid-ip2sgust>
I developed an electronic agenda so that patients could consult their
          appointments, debts and important announcements in a web application
</p> </div> </div> <!-- <div class="timeline-row">
            <div class="timeline-content">
                <p class="m-0">Loading...</p>
            </div>
        </div> --> </div> <div class="mt-3" data-astro-cid-ip2sgust> <div class="flex justify-center" data-astro-cid-ip2sgust> <a class="text-pii-green underline underline-offset-2" href="https://drive.google.com/file/d/1rwi0OJmRCtpiXT-USCO4qSJtUT4vezZk/view?usp=sharing" target="_blank" data-astro-cid-ip2sgust>
View full resume
</a> </div> </div> </div> `;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/sections/Timeline.astro", void 0);

const $$RecentProyects = createComponent(($$result, $$props, $$slots) => {
  const listProjects = PROJECTS.filter((project) => project.main == true);
  return renderTemplate`${maybeRenderHead()}<div id="projects" class="mx-10 mt-12"> <div class="flex justify-center mb-5"> <div class="w-auto"> <h2 class="text-pii-gray text-center text-3xl mx-14 mb-3">
Recent Projects
</h2> <div class="pt-separator-div"></div> </div> </div> <div class="mt-8"> <div class="grid grid-cols-1 md:grid-cols-4 md:gap-4 md:mx-10"> ${listProjects.map((project) => renderTemplate`${renderComponent($$result, "Card", $$Card, { "title": project.title, "urlProject": project.urlProject, "urlGithub": project.urlGithub, "description": project.description, "photo": project.photo, "slug": project?.slug, "tags": project.tags })}`)} </div> <div class="flex justify-center text-center my-4"> ${renderComponent($$result, "ButtonPrimary", $$ButtonPrimary, { "text": "View all Projects", "url": "/projects" })} </div> </div> </div>`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/sections/RecentProyects.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Main, { "title": "Portfolio | Francisco Candelario" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navbar", $$Navbar, {})} ${renderComponent($$result2, "Profile", $$Profile, {})} ${renderComponent($$result2, "Timeline", $$Timeline, {})} ${renderComponent($$result2, "RecentProyects", $$RecentProyects, {})} ` })}`;
}, "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/pages/index.astro", void 0);

const $$file = "C:/Users/Fjcc1/apps_projects/astro/portfolio_cv/src/pages/index.astro";
const $$url = "";
...
export { $$Main as $, PROJECTS as P, $$Navbar as a, $$Github as b, $$ButtonPrimary as c, index as d, index$1 as i };
